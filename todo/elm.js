...
var _user$project$Main$filteredTodos = function (model) {
	...
	return A2(_elm_lang$core$List$filter, todoFilter, model.todos);
};
...
var _user$project$Main$initialModel = {
	todos: {
		ctor: '::',
		_0: {title: 'Milk and Cookies', completed: true, editing: false, identifier: 1},
		_1: {ctor: '[]'}
	},
	todo: _elm_lang$core$Native_Utils.update(
		_user$project$Main$newTodo,
...
var _user$project$Main$footerView = function (model) {
	return A2(
...
var _user$project$Main$is13 = F2(
	function (msg, code) {
		return _elm_lang$core$Native_Utils.eq(code, 13) ? msg : _user$project$Main$NoOp;
	});
var _user$project$Main$onEnterKeyPress = function (msg) {
	return A2(
		_elm_lang$html$Html_Events$on,
		'keypress',
		A2(
			_elm_lang$core$Json_Decode$map,
			_user$project$Main$is13(msg),
			_elm_lang$html$Html_Events$keyCode));
};
var _user$project$Main$Add = {ctor: 'Add'};
var _user$project$Main$headerView = function (model) {
	return A2(
		_elm_lang$html$Html$section,
		{
			ctor: '::',
								...
								_1: {
									...
									_1: {
										...
										_1: {
											...
											_1: {
												ctor: '::',
												_0: _user$project$Main$onEnterKeyPress(_user$project$Main$Add),
												_1: {
													ctor: '::',
...
var _user$project$Main$view = function (model) {
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_1: {
				ctor: '::',
				_0: _user$project$Main$headerView(model),
				_1: {
					ctor: '::',
